...
\begin{enumerate}
\item A Cluster-Based Sampling Scheme for High-Performance Graph Neural Networks, Surendra Kumar Raut, Kishan Tamboli, \textbf{Vishwesh Jatala}, IEEE International Symposium on Performance Analysis of Systems and Software \textbf{(ISPASS)}, 2026
...
\item LoCo-GNN: Locality-Conscious High-Performance Graph Neural Networks, Niharika Nayak, Kishan Tamboli, \textbf{Vishwesh Jatala}, International Conference on Parallel and Distributed Systems  \textbf{(ICPADS)}, 2026
...
\begin{rSection}{Teaching}
	...
	\item 	CSL100/MAL400: Introduction to Programming
...
\begin{rSection}{Student Mentoring}
	\begin{itemize}
		...
		\item \textbf{M.Tech:}
		\begin{itemize}		
			\item Vanshika Srivastava
			\item Sanoop TV
			\item Kushal Khachane
...
\begin{itemize}
\item Invited Speaker at the Workshop on Software Framework (AMReX) \& Computational Mathematics for Scalability of Applications, 7-8 September 2026, C-DAC, Pune (Online)
\item Invited talk on "High Performance Distributed Graph Neural Networks" at the 8th Indian Symposium on Computer Systems (IndoSys), Delhi, 2026
\item Invited talk on \textbf{Pre-failure alert generation for equipment \& cobble reduction based on data analytics and video analytics at BRM} as a Distinguished Speaker at the Workshop on Digital Initiatives for Increasing Transparency in Governance, 2026
...
\begin{itemize}	
	\item \textbf{2027:}
	\begin{itemize}	
		\item Program Committee, ISEC, 2027
	\end{itemize}
	\item \textbf{2026:}
	\begin{itemize}	
		\item Workshop Co-Chair, HiPC 2026
		\item Workshop Committee Member, AI on HPC at ISC High Performance 2026
	\end{itemize}
	\item \textbf{2025:}
	\begin{itemize}	
